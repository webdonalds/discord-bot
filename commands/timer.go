...
func (c *TimerCommand) Execute(args []string, _ *discordgo.MessageCreate) (responses.Response, background.Watcher, error) {
	duration, err := time.ParseDuration(args[0])
	if err != nil {
		return responses.NewSimpleResponse("시간 패턴을 파싱할 수 없습니다."), nil, nil
	}
	...
	return responses.NewSimpleResponse(msg), watcher, nil
}
